...
fun Settings() {
    LazyColumn(){
        ...
        item {
            ItemSetting(text = "Ver enlaces ocultos", icon = Icons.Outlined.Lock, {})
        }
        item {
        ...
        item {
            ItemSetting(text = "Acerca de...", icon = Icons.Outlined.Info, {})
        }
    }
}

@Composable
private fun ItemSetting(text: String, icon: ImageVector, onClick: () -> Unit){
